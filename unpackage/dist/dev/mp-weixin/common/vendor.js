...
/***/ 21:
/*!**********************************************!*\
  !*** F:/object/uni-app/游米游/umiu/http/api.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
//筛选条件接口-定制师列表
function getcustomDesignerselct() {
  return (0, _request.default)({
...
//预约导游-列表
function getCustomizers(page, city_code, sex, goodat_type, sort) {
  return (0, _request.default)({
    url: "/api/customizers",
    data: {
      page: page,
...
//工作室(其他用户)-详情
function usersStudio(id, openid) {
  return (0, _request.default)({
    url: "/api/users/" + id + "/studio?openid=" + openid });

}
//短视频-列表
function videos(page, id) {
  return (0, _request.default)({
    url: "/api/users/".concat(id, "/short-videos"),
    data: {
      page: page } });
...
//圈子(我的)-列表
function circle(page, id) {
  return (0, _request.default)({
    url: "/api/users/".concat(id, "/circle"),
    data: {
      page: page } });
...
//游记(我的)-列表
function travels(page, id) {
  return (0, _request.default)({
    url: "/api/users/".concat(id, "/travels"),
    data: {
      page: page } });
...
//其他用户-问答
function questions(page, id) {
  return (0, _request.default)({
    url: "/api/users/".concat(id, "/questions"),
    data: {
      page: page } });
...
//登录
function loginPassword(mobile, password, userInfo, openid, code) {
  return (0, _request.default)({
...
function getResources(id, page, type, keywords, city_code, destination_code, client) {
  ...
  return (0, _request.default)({
    url: "/api/users/".concat(id, "/distributions"),
    data: data });

}
//资源-详情
function sourcesDetail(id, type) {
  return (0, _request.default)({
...
//分销的资源-详情
function distributionDetail(id, type) {
  return (0, _request.default)({
...
//评价-新增(对已完成订单评价)
function evaluationsOrders(id, service_attitude, sight_explain, travel_execution, tags, userInfo, openid) {
  return (0, _request.default)({
...
//小程序-粉丝绑定
function bindfans(id, user_id, code, openid, userInfo) {
  return (0, _request.default)({
    url: "/api/wechat/fans",
    method: 'POST',
    data: {
...
function grabs(id) {
  return (0, _request.default)({
    url: "/api/grabs/".concat(id, "/confirm"),
    method: 'PUT' });

}
//登录
function loginPasswords(mobile, userInfo, openid, wx_code, code) {
  return (0, _request.default)({
    url: "/api/wechat/authorizeLogin",
    method: 'POST',
    data: {
...
//定制师-浏览历史列表
function access_records(openid) {
  return (0, _request.default)({
    url: "/api/customizers/access-records?openid=" + openid });

}
//定制师-浏览历史删除
function access_records_del(id) {
  return (0, _request.default)({
...
function distributionsOrders(data) {
  // let data = {}
  if (data.team_id) {
  ...
  return (0, _request.default)({
    url: "/api/distributions/".concat(data.id, "/orders?type=").concat(data.type),
    method: 'POST',
    data: data });
...
//短视频-详情
function shortvideos(id) {
  return (0, _request.default)({
    url: "/api/short-videos/" + id });

}
//评论列表
function comments(page, type, id) {
  return (0, _request.default)({
...
//问题-详情
function questionAnswers(page, order, id) {
  return (0, _request.default)({
...
function ordersDetail(data) {
  return (0, _request.default)({
    url: "/api/orders/".concat(data.id) });

}
//取消订单
function ordersCancel(data) {
  return (0, _request.default)({
    url: "/api/orders/".concat(data.id, "/cancel"),
    method: 'PUT' });
...
/***/ 22:
/*!**************************************************!*\
  !*** F:/object/uni-app/游米游/umiu/http/request.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
